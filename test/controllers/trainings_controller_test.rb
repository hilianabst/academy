...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { description: @training.description, name: @training.name, url_video: @training.url_video } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { description: @training.description, name: @training.name, url_video: @training.url_video } }
